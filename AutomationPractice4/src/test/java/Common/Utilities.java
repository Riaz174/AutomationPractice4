  ...
  @BeforeMethod
	  ...
	  public void Browsers(String browsers ,String Wbsite) {
		  if(browsers.equalsIgnoreCase("Chrome")) {
			  ...
			  System.setProperty("webdriver.edge.driver", "C:\\Users\\riaz_\\git\\repository8\\AutomationPractice4\\src\\Drivers\\msedgedriver.exe");
...
@AfterMethod
  ...
  public void shots() throws IOException {
	  ...
	  FileHandler.copy(ks, new File("C:\\Users\\riaz_\\git\\repository8\\AutomationPractice4\\Pictures\\" + sd + " pictureofwebsite.jpg"));
